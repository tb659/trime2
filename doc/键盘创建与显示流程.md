...
- **布局层级**：`RootInputView` → `mCenterLayout` → `mInputViewRoot` → [`mCandidateView`, `mInputView`]
...
private void initView() {
    ...
    params.setMargins(
        ...
        margins.getSize("bottom", elevation / 3 * 2)  // 下边距更大，营造立体感
    );
