...
rows = {
    ...
    -- 第四行
    {
        ...
        keys = {
            { width = 1 },
            { click = "Keyboard_symbols", width = 13.7, long_click = "Mode_switch", hint_long = "", swipe_up = "Keyboard_settings", hint_up = "", swipe_right = "Schema_settings", hint_right = "", background = "kafei/xrcd.png", margins = { left = 0, top = 0, right = 0, bottom = 0 }, preview = nil },
