...
rows = {
    -- 第一行
    {
        ...
        keys = {
            ...
            { click = "p", swipe_up = "0", long_click = "~", style = "hint_offset" },
            { width = 1 },
        }
    },
    -- 第二行
    ...
    -- 第三行
    {
        ...
        keys = {
            ...
            { click = "z", swipe_up = "`", style = "hint_offset" },
            ...
            { click = "BackSpace", width = 13.7, swipe_up = "Clear", swipe_left = "ClearH", style = "backspace" },
            { width = 1 },
        }
    },
    -- 第四行
