...
overrides = {
    [1] = {
        ...
        [2]  = { background = "zhuji/q.png", text_color = 0xff, hint_up = "", hint_long = "" },
        [3]  = { background = "zhuji/w.png", text_color = 0xff, hint_up = "", hint_long = "" },
        [4]  = { background = "zhuji/e.png", text_color = 0xff, hint_up = "", hint_long = "" },
        [5]  = { background = "zhuji/r.png", text_color = 0xff, hint_up = "", hint_long = "" },
        [6]  = { background = "zhuji/t.png", text_color = 0xff, hint_up = "", hint_long = "" },
        [7]  = { background = "zhuji/y.png", text_color = 0xff, hint_up = "", hint_long = "" },
        [8]  = { background = "zhuji/u.png", text_color = 0xff, hint_up = "", hint_long = "" },
        [9]  = { background = "zhuji/i.png", text_color = 0xff, hint_up = "", hint_long = "" },
        [10] = { background = "zhuji/o.png", text_color = 0xff, hint_up = "", hint_long = "" },
        [11] = { background = "zhuji/p.png", text_color = 0xff, hint_up = "", hint_long = "" },
    },
    [2] = {
        margins = { left = 0, top = 0, right = 0, bottom = 0 },
        padding = { left = 0, top = 0, right = 0, bottom = 0 },
    ...
    [3] = {
        margins = { left = 0, top = 0, right = 0, bottom = 0 },
        padding = { left = 0, top = 0, right = 0, bottom = 0 },
        [2] = { margins = { left = 2, top = 0, right = 2, bottom = 5 } },
        ...
        [6] = { background = "zhuji/v.png", text_color = 0xff, hint_up = "", hint_long = "" },
        ...
        [10] = { margins = { left = 2, top = 0, right = 2, bottom = 5 } },
    },
    [4] = {
